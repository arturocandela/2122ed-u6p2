 ...
 * <p>
 * La clase calculadora tiene la finalidad de reaalizar los ejercicios planteados en la práctica 2 para trabajar un poco con la documentación del código de java. Sus principales métodos son para sumar, restar, multiplicar y dividir diferentes enteros que pasaremos como argumento al llamar al método.</p>
 * 
 * @author isaac
 * @version 2.5
...
public class Calculadora {
	 ...
	 * @exception ArithmeticException al intentar dividir un número por 0
	 */
